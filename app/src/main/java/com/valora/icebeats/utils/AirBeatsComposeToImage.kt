...
import com.valora.icebeats.ui.component.LyricsBackgroundType
import com.valora.icebeats.ui.component.LyricsCardConfig
import com.valora.icebeats.ui.component.LyricsGlassStyle
import com.valora.icebeats.ui.component.LyricsLayoutStyle
...
object icebeatsComposeToImage {
    ...
    private fun drawBranding(
        ...
        val rawLogo   = context.getDrawable(R.drawable.icebeats)?.toBitmap(logoSize, logoSize)
    ...
    fun saveBitmapAsFile(context: Context, bitmap: Bitmap, fileName: String): Uri {
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues = ContentValues().apply {
                ...
                put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/icebeats")
            }

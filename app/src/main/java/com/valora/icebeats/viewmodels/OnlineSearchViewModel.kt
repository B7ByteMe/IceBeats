...
import com.valora.icebeats.constants.HideVideoKey
                ...
                if (filter == null) {
                    if (summaryPage == null) {
                        if (musicProvider == "JIOSAAVN") {
                            com.valora.icebeats.jiosaavn.JioSaavnApi.searchSongs(query)
                                .onSuccess { songs ->
                                    summaryPage = SearchSummaryPage(
                                        summaries = listOf(
                                            com.valora.icebeats.innertube.pages.SearchSummary(
                                                title = "Songs",
                                                items = songs
                                            )
                                        )

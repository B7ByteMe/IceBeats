...
class MusicWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.valora.icebeats.ACTION_PLAY_PAUSE"
        const val ACTION_PREV = "com.valora.icebeats.ACTION_PREV"
        const val ACTION_NEXT = "com.valora.icebeats.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.valora.icebeats.ACTION_SHUFFLE"
        const val ACTION_LIKE = "com.valora.icebeats.ACTION_LIKE"
        const val ACTION_REPLAY = "com.valora.icebeats.ACTION_REPLAY"
        const val ACTION_OPEN_APP = "com.valora.icebeats.ACTION_OPEN_APP"
        const val ACTION_STATE_CHANGED = "com.valora.icebeats.ACTION_STATE_CHANGED"
        const val ACTION_UPDATE_PROGRESS = "com.valora.icebeats.ACTION_UPDATE_PROGRESS"

...
import com.valora.icebeats.viewmodels.ArtistSongsViewModel
...
fun ArtistSongsScreen(
    ...
    // Envolver canciones para selecci•n
    ...
    // Auto-focus cuando se activa b•squeda
    ...
    Box(
            ...
            actions = {
                when {
                    selection -> {
                        ...
                        // Men• de opciones para selecci•n
                        IconButton(
                            onClick = {
                                menuState.show {
                                    SelectionSongMenu(
        ...
        // FAB para shuffle (solo visible cuando no hay b•squeda ni selecci•n)

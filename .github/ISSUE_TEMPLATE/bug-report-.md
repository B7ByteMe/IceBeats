---
name: Bug Report
about: Report a bug found in IceBeats to help us improve the application
...
```
**How to capture logs:**
- Use `adb logcat | grep -i IceBeats` for filtered logs
...
- [ ] I have tested on the latest version of IceBeats
